...
} from "./chunk-DUKEDOZX.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-XQNMIIA2.js";
import "./chunk-RKL5KKQG.js";
import {
  isRTL
} from "./chunk-JQCJAYTB.js";
import {
...
} from "./chunk-VBX4H6XT.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-4QTL6KCX.js";
import {
  createColorClasses,
  hostContext
...
import {
  getIonMode,
  isPlatform
} from "./chunk-GDOYRXVN.js";
import {
  shouldUseCloseWatcher
} from "./chunk-E6FBOFG2.js";
import {
  transition
} from "./chunk-RH4EZEC3.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-ceb5RaMT-PM3APLLV.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-5DQ7Fc4V-ZLWGSMIY.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-DyOpfTg6-WPTMQTH7.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CPLxO-Ev-Q2GNOXDG.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-KHHGTSAA.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-6K4BXLOY.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BKw2CAHc-ZOHK4AO5.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-RUKR4GCJ.js.map
